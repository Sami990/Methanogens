    ...
    for i=1:length(downloadedData)
        ...
        elseif ~isempty(generalReac(contains(generalReac,'general reaction')))
            ...
            elseif ~isempty(rxnEquation(contains(rxnEquation, 'n')))
                ...
                greenLightedChars = '1234567890C<=>+(side) ';
...
if recBeingBuilt
    ...
    ReactionFormulas(313) = {'C04488 + C03576 + 2 C01330(side1) <=> C01217 + C03920 + 2 C01330(side2)'};
    ReactionFormulas(545) = {'C18799 + C03576 + 2 C01330(side1) <=> C18802 + C03920 + 2 C01330(side2)'};
